...
echo '<a href="' . $RootPath . '/BOMUpload2.php"><h3>' . _('进行上传资料确认界面') . '</h3>';
  
}  
 else  {	echo '<form action="BOMUpload.php" method="post" enctype="multipart/form-data">';
    echo '<div class="centre">';
	   echo '<table><tr><div class="centre"><td><a href="' . $RootPath . '/upload/BomUploadSample.xls" target="_blank">' . '下载标准格式文件' . '</td></tr></div></table>';
