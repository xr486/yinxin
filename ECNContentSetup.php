...
$sql = "select a.*,b.change_type,b.change_text,b.leibie,b.pic_path,b.change_name,b.id,c.item_name  from bom_headers_all a,bom_huishang_all b  ,sf_item_no c
		where  b.modify_flag='N' and a.assembly_item_no=b.order_number and a.assembly_item_no = c.item_no     ";
 
 $sql = $sql . " order by b.creation_date desc";
 $result = DB_query($sql, $db);

if (isset($_POST['Search']) or isset($_POST['Go']) or isset($_POST['Next']) or isset($_POST['Previous'])) {
        $sql = "select a.*,b.change_type,b.change_text,b.pic_path,b.leibie,b.change_name,b.id,c.item_name  from bom_headers_all a,bom_huishang_all b  ,sf_item_no c
		where  b.modify_flag='N' and a.assembly_item_no=b.order_number and a.assembly_item_no = c.item_no   ";
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('查找BOM') . '</p>';
...
echo '<input type="text" id="text_slect_customer" name="item_name" value="' . $_POST['item_name'] . '" size="20" maxlength="250" />
...
if (isset($_POST['Search']) or isset($result) or isset($_POST['Go']) or isset($_POST['Next']) or isset($_POST['Previous'])) {
        ...
        if (DB_num_rows($result) <> 0) {
                ...
                while (($myrow = DB_fetch_array($result)) and ($RowIndex <> $_SESSION['DisplayRecordsMax'])) {
                        ...
                        echo '  <td><a href="' . $RootPath . '/ECNContentSetup2.php?New=Yes&Updateorder_number=' . $myrow['assembly_item_no'] . '&change_name=' . $myrow['change_name'] . '">' . $myrow['change_name'] . '</td>
