...
<div id="BodyDiv">
<div id="BodyWrapDiv">
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="供应商付款明细查询" alt="供应商付款明细查询">供应商付款明细查询</p>
...
$sql ="select a.po_num,a.check_amount,c.transaction_amount,c.dis_amount,a.note,a.amount header_amount,a.youhui_amount
