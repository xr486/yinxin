...
$sql8="SELECT  b.item_no,b.item_name,b.item_desc,c.start_quantity,c.wip_entity_name,c.wip_entity_id  FROM sf_item_no b,wip_jobs_all c, wip_mo_print g where b.item_no=c.primary_item 
AND c.wip_entity_name = g.wip_entity_name
...
<head>
	...
	@media print {
        ...
        .prall { width: 1080px;margin: 0 auto; overflow: hidden; border: 1px solid #e7e7e7;  border-radius: 5px; padding: 10px; }
        ...
        .tab {width: 100%;height: auto;overflow: hidden;margin: 5px 0;font-size: 14px;line-height: 21px;}/*字大小和行距*/
...
<table width="100%" border="0">
  ...
  <td style="text-align:center;" ><font size="6" ><?php echo $myrow5['coyname'];?> </font></td>
   <td id="number" style="display:none;"><?php echo $myrow6['wip_entity_name'];?></td>
...
<td ><?php echo $myrow6['item_name'].$myrow6['item_desc'];?> </td>
    ...
    <!-- <HR width="100%"  color="black" SIZE=1/> -->
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0"  style="table-layout:fixed;">
            <tr> <th style="text-align:left;" width="15"   ><center>序号</th>
			 <th style="text-align:left;" width="20"   ><center>制程</th>
		...
		<td style="text-align:left;"><?php echo $myrow2['operation_seq_num'];?></td> 
