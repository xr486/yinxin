...
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/magnifier.png" title="料号修改" alt="料号修改">料号修改</p>
            ...
            <table cellpadding="2" class="selection">
                ...
                if (DB_num_rows($result) <> 0) {
                    ...
                    while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> $_SESSION['DisplayRecordsMax'])) {//$_SESSION['DisplayRecordsMax']
                        ...
                        ?>
                        <td>
                            <a href="<?= $RootPath ?>/segment1Up2.php?ItemID=<?= $myrow['item_id'] ?>"><?= $myrow['item_no'] ?>
                        </td>
