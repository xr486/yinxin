...
foreach($rows as $row)
	...
	while ($v = DB_fetch_array($result_num)) {
	 ...
	 $writer->writeSheetRow('Sheet1', array($v['ym'],$v['sub_code'],$v['item_no'],$v['item_name'],$v['item_desc'] ,$v['end_quantity'] ,
        ));
	 }
