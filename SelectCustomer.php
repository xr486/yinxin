...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    $sql = 'select customer_code,customer_name,customer_address,customer_contacts,contacts_phone,contacts_mail,effective_date,disable_date'
    ...
    if(isset($_POST['CustomerAddress']) and $_POST['CustomerAddress'] != ''){
        $sql = $sql." and customer_address ".LIKE." '%".$_POST['CustomerAddress']."%' ";
    }
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    echo '<tr>
                    ...
                    <th class="ascending">' . _('联系人电话') . '</th>
                    <th class="ascending">' . _('联系人邮箱') . '</th>
                    <th class="ascending">' . _('生效日期') . '</th>
                    <th class="ascending">' . _('失效日期') . '</th>
            </tr>';
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> $_SESSION['DisplayRecordsMax'])) {
			...
			echo '  <td><a href="' . $RootPath . '/Customers.php?UpdateCustomerCode=' . $myrow['customer_code'] . '">' . $myrow['customer_code'] . '</td>
				...
				<td>' . $myrow['effective_date'] . '</td>
				<td>' . $myrow['disable_date'] . '</td>
				<td>' . $myrow['CreditLimit'] . '</td>
