...
if (isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    $sql = "select pha.invoice_name,ar_invoice_type,invoice_type,
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('客户发票管理') . '</p>';
...
<input type="submit" name="add_new" value="新增销售发票">&nbsp;&nbsp;
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    ...
    echo '<tr>   <th class="ascending" width = 100>' . _('发票单号') . '</th>
                    ...
                    <th class="ascending"width = 90>' . _('税金') . '</th>  
                    <th class="ascending"width = 90>' . _('免开票金额') . '</th>                           
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> 10 )) {
          ...
          if ($myrow['invoice_type']=='费用发票' ) {
            echo '  <td><a href="' . $RootPath . '/ARInvoiceModify3.php?Updatepo_num=' . $myrow['invoice_name'] . '">' . $myrow['invoice_name'] . '</td>';
		} else {
            echo '  <td><a href="' . $RootPath . '/ARInvoiceModify2.php?Updatepo_num=' . $myrow['invoice_name'] . '">' . $myrow['invoice_name'] . '</td>';
		}
...
if (isset($_POST['add_new'])) {
        header('Location: ARInvoice.php?New=Y');
}
if (isset($_POST['add_fee'])) {
        header('Location: ARInvoice1.php?New=Y');
}
if (isset($_POST['redfee'])) {
        header('Location: ARInvoiceBack.php?New=Y');
} 
