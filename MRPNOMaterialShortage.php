...
$Title = _('非标材料建议采购明细报表');
$ViewTopic = '非标材料建议采购明细报表';
$BookMark = '非标材料建议采购明细报表';
...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    $sql ="SELECT a.customer_code,c.order_number,c.line,c.item_no,c.item_name,c.item_description ,c.userd_per_quantity ,c.userd_quantity,c.uom,b.need_date
	FROM so_headers_all a, so_lines_all b ,so_line_details_all c 
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('非标材料建议采购明细报表') . '</p>';
