...
$msg = '供应商编号'.$_SESSION['OrderNum' . $identifier].'建立成功！';
                prnMsg($msg, success);
                 echo '<br /><div class="centre"><a href="' . $RootPath . '/AddSupplier.php?New=Y">' . _('继续创建供应商') . '</a></div>';
                 ...
                 echo '<br /><div class="centre"><a href="' . $RootPath . '/SearchSupplier.php?UpdatevendorCode=' . $_SESSION['OrderNum' . $identifier] . '">' . _('查询供应商资料') . '</a></div>';
...
$sql = "insert into vendors_file (file_name,vendor_code,file_patch,creation_date,created_by) values ('" . $_POST['file_name'] . "','" . $_POST['OrderNum1'] . "','" . $dest . "','" . $time . "','" . $_SESSION['UserID'] . "')";
