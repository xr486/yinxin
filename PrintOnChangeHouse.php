...
<p class="p2">调 拨 单</p>
<div class="version">
    <span>记录编号：YXZD-CC-ZD-002-R05</span>
    <span>版本号：A/0</span>
</div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
     ...
     <?php
  $sql2 = "SELECT a.subinventory_from,a.subinventory_to, a.item_no, ABS(a.quantity) quantity,b.item_name,b.item_desc,b.sub_locator,b.units,a.lot_num,a.project_name
  FROM  inv_transactions_all_temp a ,sf_item_no b
      where a.item_no = b.item_no and a.quantity > 0  and a.trans_num = '" .$Updatedelivery_num."' 
       ";
		// ECHO  $sql2;
...
?>
    ...
    <table width="100%"  cellpadding="0" cellspacing="0" class="content_tab" >
        ...
        <tr>
            ...
            <th style="text-align:left;background-color: #deecfe;" width="100"><center>调出仓</center></th>
            <th style="text-align:left;background-color: #deecfe;" width="100"><center> 调入仓 </center></th>  
        </tr>
		...
		<tr>
            ...
            <td style="text-align:left;"><center><?php echo $myrow2['subinventory_to'];?></center></td>
