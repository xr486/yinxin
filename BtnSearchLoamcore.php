...
if (!isset($_POST['PageOffset'])) {
    ...
    //查找数据的SQL
    $sql = 'select lcid,lcname,paint,cprice,trueweight,weight,sandboxid,workorder,p_id from wip_loamcore where workorder=1 ';
            ...
            function ok()
            {
                switch ($('#cat').val()){
                    case 'buliao':
                        ...
                        W.document.getElementById('lcname').value = $("label#lcname").text();
