...
if (isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
   ...
   $sql2 = "insert into wip_inv_onhand_temp  ( stockid,onhand_quantity )
	...
	from inv_onhand_quantity_all group by stockid ";
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('查询已领料未领全的工单') . '</p>';
