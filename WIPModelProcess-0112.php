...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    if (DB_num_rows($result) <> 0 ) {
        ...
        while (($myrow = DB_fetch_array($result))
            ...
            //多种不良
            echo '<td>
                      <a href="addMoreBadReason.php?id='.$myrow['wip_entity_id'].'&reason_type=model">填写多种不良</a>
                   </td>';
            //显示报废数量
            echo '<td><input 
            ...
            //多种报废
            echo '<td>
                      <a href="addMoreScrapReason.php?id='.$myrow['wip_entity_id'].'&reason_type=model">填写多种报废</a>
                   </td>';
