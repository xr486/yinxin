...
if (isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    ...
    //查找数据的SQL
    $sql = "select item_id,item_no,item_name,units,min_order,safe_qty,item_desc,lead_time,manufacture_time,yanse from sf_item_no where item_type='M' ";
...
?>
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/magnifier.png" title="材料料号维护" alt="材料料号维护">材料料号维护</p>
    ...
    <div>
        ...
        <table cellpadding="3" class="selection">
            <tr>	
                ...
                <td>料号名称：</td>
                <td><input   type="text" name="item_name" value=<?= $_POST['item_name'] ?> >
                </td> 
				  <td>规格型号：</td>
                <td><input   type="text" name="item_desc" value=<?= $_POST['item_desc'] ?> >
                </td> 
        ...
        <div class="centre"><input type="submit" name="Search" value="查找">&nbsp;&nbsp;<input type="submit" name="add_new" value="新增材料料号"></div>
