...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('BOM修改') . '</p>';
...
echo '<div class="text-nav-1"><div>' . _('版本') . ':</div>';
echo '<input type="text" name="version" value="' . $_POST['version'] . '" size="50" maxlength="100" /></div>';
