...
$sql5= "SELECT * FROM companies ";
 ...
 $sql = "SELECT c.*,d.realname,d.depart_code, b.item_name,b.item_desc,a.start_quantity
    FROM  inv_transactions_all c ,www_users d,wip_jobs_all a,sf_item_no b
...
<p class="p2">领料单</p>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
            <td style="text-align:right;">外协生产数量：</td>
  ...
  FROM  inv_transactions_all a ,sf_item_no b
      where a.item_no = b.item_no and a.transaction_type ='外协领料'   and a.trans_num = '" .$Updatedelivery_num."' 
       ";
		// ECHO  $sql2;
