...
if (isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
	...
	a.creation_date,a.order_man,a.man_contact,a.man_address
...
and userid = '" . $_SESSION['UserID'] . "' ";
    ...
    if (isset($_POST['stockid']) and $_POST['stockid'] != '') {
        $sql = $sql . " and c.chuanghu_bu_item  like  '%" . $_POST['stockid'] . "%'";
    }
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    ...
    echo '<tr>
					...
					<th class="ascending"width = 70>' . _('打印') . '</th>
                    <th class="ascending"width = 70>' . _('状态') . '</th>
                    <th class="ascending"width = 200>' . _('加盟商') . '</th>
					<th class="ascending"width = 100>' . _('客户名称') . '</th>
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> 10 )) {
            ...
            echo '  <td><a href="' . $RootPath . '/SearchSO4.php?Updateso_num=' . $myrow['order_number'] . '">' . $myrow['order_number'] . '</td>
