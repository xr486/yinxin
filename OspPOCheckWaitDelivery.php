...
$sql ="SELECT  a.receipt_line_id,a.receipt_num,a.uom,a.receipt_line,
a.unit_price,a.transaction_quantity, g.item_name,a.check_quantity,a.check_price,a.check_amount,a.remark,a.creation_date,
a.stockid,b.delivery_date,b.vendor_code,d.vendor_name,a.po_num,a.po_line,b.receipt_type
...
and b.vendor_code = d.vendor_code 	and a.po_line=e.line and a.po_num=e.po_num  and a.wait_inspect_quantity=0
and a.check_flag ='N'   and c.po_num=e.po_num and c.order_type = '外协采购'	 		   
";
...
echo '
        ...
        <input type="submit" name="Search" value="查询未对账明细"> &nbsp;&nbsp;';
        // echo '   <div class="export" >
        //   <a href="' . $RootPath . '/OspPOCheckWaitDeliveryExcel.php?order_number=' .$_POST['order_number'] .'&vendor_code=' .$_POST['vendor_code'] .'&vendor_name=' .$_POST['vendor_name'] . '&FromDate=' .$_POST['FromDate'] .'&ToDate=' .$_POST['ToDate'] . '&FromDate2=' .$_POST['FromDate2'] .'&ToDate2=' .$_POST['ToDate2']  .' ">' .'导出' . '</a>
        //   </div>';
          echo '  </div>
';
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('外协采购待对账报表') . '</p>';
