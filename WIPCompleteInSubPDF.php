...
$sql5= "SELECT * FROM companies ";
 ...
 $sql = "SELECT distinct b.so_header_number,a.transaction_date,a.wip_entity_name,c.depart_code,a.creation_date,c.realname,a.subinventory_from,a.trans_num,(SELECT realname from www_users d where d.userid = a.sub_approved_by ) sub_realname,a.sub_approve_date  FROM inv_transactions_all_temp a, wip_jobs_all b,www_users c where a.wip_entity_name=b.wip_entity_name and a.created_by = c.userid 
 and a.trans_num = '" .$Updatedelivery_num."'
         ";
        //  echo $sql;
...
?>
    ...
    <table width="100%"  cellpadding="0" cellspacing="0" class="content_tab" >
        ...
        <tr>
            ...
            <th style="text-align:left;" width="100"><center>规格 </center></th>
            <th style="text-align:left;" width="100"><center>SN/批号</center></th>
            <th style="text-align:left;" width="40"><center>单位</center></th>
            <th style="text-align:left;" width="72"><center> 入库数量 </center></th>   
            <th style="text-align:left;" width="72"><center> 入库仓库 </center></th>  
