...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
	...
	a.wip_entity_name,c.stockid,e.item_name,e.item_desc, a.plan_start_date,e.gongyi,
	c.uom,a.start_quantity,a.quantity_completed,d.need_date,a.make_factory
	 from wip_jobs_all a, 
	 customers b, 
	 so_lines_all c  , 	
	   so_headers_all d,
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('工单已入库未关闭明细') . '</p>';
...
echo '<input type="text" name="customer_code" value="' . $_POST['customer_code'] . '" size="11" maxlength="25" /> </div>';
...
echo '</table><div class="centre"><input type="submit" name="Search" value="查找">
 <a href="' . $RootPath . '/WIPWaitColseExcel.php?wip_entity_name=' .$_POST['wip_entity_name'] . '&item_no=' .$_POST['item_no'].
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    echo '<tr>  	
	<th bgcolor="#87CEFA" class="ascending" width = 60>' . _('客户') . '</th>	
                   <th bgcolor="#87CEFA" class="ascending" >' . _('订单号') . '</th>				
					...
					<th bgcolor="#87CEFA"   >' . _('单位') . '</th> 	
					  <th bgcolor="#87CEFA" class="ascending" >' . _('生产数量') . '</th>
					  <th bgcolor="#87CEFA" class="ascending" >' . _('完工数量') . '</th>
