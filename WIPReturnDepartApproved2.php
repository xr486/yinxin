...
if (isset($_POST['Reject'])) 
{
    ...
    if ($errorflag == 0) 
    {
        ...
        // DB_Txn_Commit($db);
        prnMsg('工单退料部门拒绝完成',success);
        //echo "<script>location.href='index.php';</script>";
        header("Location: WIPReturnDepartApproved.php");
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('工单退料部门审核') . '</p>';
...
if(isset($NUM) and $NUM != '')
{
  ...
  {
    //unset($result);
    prnMsg(_('没有工单退料单据，请重新输入条件查询！') ,'error');
  }
}
?>
