...
$objActSheet->setCellValue('A2', " $C1  销售送货对账单");    
//合并单元格   
...
$objActSheet->setCellValue('B4', '订单编号');    
$objActSheet->setCellValue('C4', '送货单号');    
$objActSheet->setCellValue('D4', '送货日期');   
$objActSheet->setCellValue('E4', '规格型号');    
$objActSheet->setCellValue('F4', '产品名称');    
$objActSheet->setCellValue('G4', '单位');    
$objActSheet->setCellValue('H4', '数量');   
$objActSheet->setCellValue('I4', '单价');    
$objActSheet->setCellValue('J4', '货款调整');    
$objActSheet->setCellValue('K4', '金额');    
$objActSheet->setCellValue('L4', '发票编号');   
$objActSheet->setCellValue('M4', '状态');    
...
$Ward=$mysql['Ward'];    
    ...
    $objActSheet->setCellValue('B'.$n, $mysql['so_order_number']);    
    $objActSheet->setCellValue('C'.$n, $mysql['delivery_num']);    
    $objActSheet->setCellValue('D'.$n, date('Y-m-d',$mysql['delivery_date']));   
	$objActSheet->setCellValue('E'.$n, $mysql['stockid']);  
	$objActSheet->setCellValue('F'.$n, $mysql['item_desc']);    
    $objActSheet->setCellValue('G'.$n, $mysql['uom']);    
    $objActSheet->setCellValue('H'.$n, $mysql['delivery_quantity']);    
    $objActSheet->setCellValue('I'.$n, $mysql['price']);   
	$objActSheet->setCellValue('J'.$n,  $mysql[' '] );  
	$objActSheet->setCellValue('K'.$n, $mysql['line_amount'] );    
