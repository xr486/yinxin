...
if (isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    ...
    //查找数据的SQL
    $sql = 'select p_id,p_name,material_quality,model_unit_price,flag,polish_unit_price,stock_count,production_oneday from wip_endproducts where 1=1 ';
        ...
        if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
            ...
            <table cellpadding="2" class="selection">
                <tr>
                    ...
                    <th class="ascending" width = "120" >造型单价</th>
                    <th class="ascending" width = "120" >打磨单价</th>
                    <th class="ascending" width = "120" >库存数量</th>
                    <th class="ascending" width = "120" >一天生产个数</th>
                    <th class="ascending" width = "120" >有效状态</th>
                </tr>
                <?php
                ...
                if (DB_num_rows($result) <> 0) {
                    ...
                    while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> 10)) {//$_SESSION['DisplayRecordsMax']
                        ...
                        ?>
                        <td>
                            <a href="<?= $RootPath ?>/UpdateEndProducts.php?p_id=<?= $myrow['p_id'] ?>"><?= $myrow['p_id'] ?>
                        </td>
                        <td><?= $myrow['p_name'] ?>   </td>
