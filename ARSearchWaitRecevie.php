...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    $sql =" SELECT customer_name,ch.customer_code,ch.invoicenum,ch.invoiceamount,ch.taxamount,ch.invoicedate,ch.AlreadyReceiveamount,ch.narrative,ch.createdby 	,ch.creationdate
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('查找应收账款未收款明细查询') . '</p>';
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> 10)) {//$_SESSION['DisplayRecordsMax'])
        	...
        	echo ' 
				...
				<td class="number">' .$creationdate. '</td>
