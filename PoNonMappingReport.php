...
if (isset($_POST['Search']) or isset($_POST['Go']) or isset($_POST['Next']) or
    ...
    $sql = 'SELECT  pha.po_num, pha.status, pha.note, pha.creation_date, pha.need_date, pla.line_amount,pla.quantity,pla.so_issue_qty,pla.line,pla.price,v.vendor_code, v.vendor_name, pha.need_date, pha.created_by,b.item_no,b.item_desc,b.item_name,b.units,
...
AND v.vendor_code = pha.vendor_code ';
	...
	$sql .= " and  pha.status = 'APPROVED' order by  pha.po_num";
...
if (isset($_POST['Search']) and isset($result) or isset($_POST['Go']) or isset($_POST['Next']) or
    ...
    echo '<tr>      
				   ...
				   <th class="ascending"width = 90>' . _('已分配数量') . '</th>
