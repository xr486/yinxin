...
WHERE
	a.item = b.item_no
        ...
        if (DB_num_rows($result2) == 0) {
            ...
            while ($myrow = DB_fetch_array($result2)) {
                ...
                echo '
                      ...
                      <td>' . $myrow['item'] . '</td>
                      <td>' . $myrow['yanse'] . '</td>
                      <td>' . $myrow['chuanghu_height'] * 100 . '</td>
                      <td>' . $myrow['chuanghu_width'] * 100 . '</td>
                      <td>' . $myrow['zhe']  . '</td>
        ...
        echo '</br><div class="centre">
			<input type="submit" name="Submit" value="' . _('签核') . '" />
		&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="Submit2" value="' . _('拒签') . '" /> &nbsp;&nbsp;&nbsp;&nbsp;   <input type="submit" name="return" value="' . "返回上一层" . '" />&nbsp;
...
if (isset($_POST['Submit'])) {
    ...
    if ($_SESSION['num' . $identifier] == 400) {
        ...
        if ($InputError == 1) {
            ...
            $msg = '签核生产单成功';
            prnMsg($msg, 'success');
           echo '<br /><div class="centre"><a href="' . $RootPath . '/Manufacture_Approve.php">' . _('继续签核生产单') . '</a></div>';
        }
...
//    echo 'AAAAAAAAAA';
    header('Location: Manufacture_Approve.php');
}
