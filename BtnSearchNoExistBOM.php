...
$off = $num*($page-1);
    ...
    FROM sf_item_no  a where item_type='F'  and disable_flag<>'N'
...
api.button({
    ...
    callback:ok
            ...
            { 
                switch ($('#cat').val()){
                    case 'buliao':
                        W.document.getElementById('text_slect_new_item_no'+$('#fwValue').val()).value = $("label#form_item_no").text(); 
					    W.document.getElementById('text_slect_new_item_desc'+$('#fwValue').val()).value = $("label#form_item_desc").text();
