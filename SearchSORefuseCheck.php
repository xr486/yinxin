...
WHERE
	1 = 1
AND a.customer_code = b.customer_code  AND a.status = 'REJECTED'
";
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('查找拒签订单') . '</p>';
