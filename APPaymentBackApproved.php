...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('供应商退款签核') . '</p>';
...
echo '<td>' . _('供应商代码') . ':</td>
	<td>';
echo '<input type="text" name="vendor_code" value="' . $_POST['vendor_code'] . '" size="20" maxlength="25" /></td></tr>';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    ...
    echo '<tr>
					...
					<th class="ascending" width = 100>' . _('退款/转账单号') . '</th> 
					<th class="ascending" width = 100>' . _('类型') . '</th> 
                    <th width = 80>' . _('供应商') . '</th>
                    <th class="ascending"width = 200>' . _('供应商') . '</th>
                    <th  width = 90>' . _('退款金额') . '</th>    
                    <th  width = 90>' . _('免退款金额') . '</th>                             
                    <th  width = 150>' . _('备注') . '</th>
                    <th class="ascending"width = 90>' . _('退款日') . '</th>
