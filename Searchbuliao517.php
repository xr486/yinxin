...
$sql = 'select  a.* 
from sf_item_no  a  where  1=1 ' . $where . ' ORDER BY a.item_no  desc limit ' . $off . ',' . $num . '';
        ...
        <div id="BodyDiv">
            <div id="BodyWrapDiv">
                <p class="page_title_text">
                    <img src="/JXC/css/xenos/images/magnifier.png" title="查询图号" alt="查询图号">查询图号
                </p>
                <form action="./Searchbuliao517.php?fwValue=<?= $cat ?>&cat=<?= $cat ?>" method="POST">
                    <div>
