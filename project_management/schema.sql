...
INSERT INTO user_power(user_id,function_name,model_name,use_flag,creation_date,created_by,role_flag,role_name)
SELECT u.userid,'项目管理','项目管理','1',UNIX_TIMESTAMP(),'system','N',u.role_name
FROM www_users u
WHERE NOT EXISTS (
