...
if (isset($_POST['UpdateStatus']) ) {
    ...
    $time = time();
		...
		prnMsg('其它收入'.$_POST['transaction_num'].'待财务审核完成！',success);
...
if (isset($_POST['RejectBack']) ) {
	$time = time();
      $sql2="UPDATE fin_bank_transaction_headers_all 
		...
		prnMsg('其它收入'.$_POST['invoice_num'].'财务已拒绝！',success);
...
<div id="BodyDiv">
<div id="BodyWrapDiv">
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="其它收入待财务审核" alt="其它收入待财务审核">其它收入待财务审核</p>
