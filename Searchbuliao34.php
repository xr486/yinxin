...
$count = db_sql('select * from sf_item_no where 1=1 and item_type=4 '.$where.'',3);

$pages = ceil($count/$num);
$sql = 'select * from sf_item_no where 1=1 and item_type=4 '.$where.' ORDER BY item_id  desc limit '.$off.','.$num.'';
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./Searchbuliao34.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
