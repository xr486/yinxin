...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="/JXC/BtnSearchAPVendor.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
					...
					<tr class="EvenTableRows">
						...
						<td> <?=$row2['bank_account']?> </td>
						<td> <?=$row2['vendor_contacts']?> </td>
						<td> <?=$row2['currencycode']?> </td>
				 
						</td>
						<td>
						<input name="a" type="radio" value="选择" class="coupons" rel="<?=$row2['vendor_code']?>:<?=$row2['vendor_name']?>:<?=$row2['vendor_contacts']?>:<?=$row2['vendor_address']?>:<?=$row2['currencycode']?>:<?=$row2['bank_name']?>:<?=$row2['bank_account']?>">				 
						</td>
					</tr>
					<?php }?>
	...
	<div id="FooterDiv">
		<div id="FooterWrapDiv">
                   ...
                   <div style="display:none">
					...
					<div style="display:none">
                         <p><label class="text-info">vendorcontacts</label>　<label id="form_contacts"></label></p>
                    </div>
