...
echo '<p class="page_title_text">
		<img src="' . $RootPath . '/css/' . $Theme . '/images/supplier.png" title="' . '完工入库查询' .
 '" alt="" />' . ' ' . $Title . '
	</p>';
...
if (DB_num_rows($TransResult) == 0) {
    unset($TransResult);
    prnMsg(_('没有找到需要入库的采购单，请重新输入条件查询！'), 'info');
} else {
