...
<script type="text/javascript">
        $(document).ready(function(){           
            ...
            { 
                switch ($('#cat').val()){
                    case 'buliao':
                        W.document.getElementById('text_slect_outloccode'+$('#fwValue').val()).value = $("label#form_loccode").text(); 
					    W.document.getElementById('text_slect_outsubinventoryname'+$('#fwValue').val()).value = $("label#form_name").text(); 
