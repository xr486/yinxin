            ...
            { 
                switch ($('#cat').val()){
                    case 'buliao':
                        ...
                        var node = W.document.getElementById('btn_slect_cailiao'+$('#fwValue').val());
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./SearchCailiao.php?fwValue=<?=$fwValue?>&cat=<?=$cat?>" method ="POST">
				<div>
					...
					<tr class="EvenTableRows">
						...
						<td>
						<input name="a" type="hidden" value="选择" class="coupons" rel="<?=$row2['item_no']?>:<?=$row2['item_name']?>:<?=$row2['item_desc']?>:<?=$row2['units']?>:<?=$row2['po_price']?>">				 
						</td>
					</tr>
					<?php }?>
					...
					<br/>
					<div class="centre">
					<?=show_page('?page=',$page,$pages,$count,'&fwValue='.$fwValue.'&cat='.$cat.'&ItemNo='.$ItemNo.'&ItemDesc'.$ItemDesc.'');?>
	...
	<div id="FooterDiv">
		<div id="FooterWrapDiv">
                   ...
                   <div style="display:none">
                    ...
                    <div style="display:none">
                         <p><label class="text-info">Price</label>　<label id="form_UnitPrice"></label></p>
                    </div>
