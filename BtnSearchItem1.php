...
$off = $num*($page-1);
    ...
    FROM sf_item_no AS a where item_type='F'  and disable_flag<>'N' ".$where.'',3);

$pages = ceil($count/$num);
$sql = "SELECT a.item_no, a.item_desc
FROM sf_item_no AS a where item_type='F' and disable_flag<>'N'".$where.' ORDER BY item_no  desc limit '.$off.','.$num.'';
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="/JXC/BtnSearchItem1.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
