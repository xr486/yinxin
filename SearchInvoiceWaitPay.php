...
$where = " and status='核准' and invoice_type<>'红字发票'    ";
if ($invoice_num) {
...
WHERE  invoice_amount > payment_amount " . $where . "", 3
				);
...
$sql = "SELECT *
FROM ar_invoice_headers_all
WHERE invoice_amount > payment_amount " . $where . " ORDER BY invoice_num  desc limit " . $off . "," . $num . "";
//  echo $sql;
		...
		<div id="BodyDiv">
			<div id="BodyWrapDiv">
				<p class="page_title_text">
					<img src="./css/xenos/images/magnifier.png" title="查询待收款发票" alt="查询待收款发票">查询待收款发票
				</p>
				<form action="./SearchInvoiceWaitPay.php?fwValue=<?= $cat ?>&cat=<?= $cat ?>" method="POST">
					<div>
