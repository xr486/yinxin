...
if (isset($_GET['file_name'])   ) {
 ...
 echo '<meta http-equiv="refresh" content="0; url=' . $RootPath .
                 '/AddCustomer2.php?UpdateCustomerCode='. $_GET['UpdateCustomerCode'] . '" />';
 //DB_Txn_Commit($db);
        ...
        if ($InputError != 1) {
            ...
            if (isset($_POST['Addcustomer'])) {
                ...
                $sql = "UPDATE customers
			      ...
			      zhuce_address ='" . $_POST['zhuce_address'] . "',
...
<input type="text" readonly="readonly" value="<?= $_POST['customer_code'] ?>" />
				...
				<input  type="text" name="customer_name" readonly="readonly" value="<?=$_POST['customer_name']
...
<div class="text-nav-1"><div>币别</div>
        ...
        <div class="text-nav-1"><div>纳税人识别号</div>
				...
				<input type="text" name="bank_account" size="62" maxlength="60"value="<?=$_POST['bank_account'] ?>"  />
                               </div>
			...
			<div><?php echo '<a href="' . $RootPath . '/SussCustomer.php?OrderNum=' . $myrow['customer_code'] . '&customer_type='.$myrow['customer_type'] .'">附件上传</a>';?></div>
...
// <td><a href="' . $RootPath . '/Quote3.php?New=Yes&Updateorder_number=' . $myrow['file_patch'] . '">预览</td>
       echo '
             ...
             <td><a href="' . $RootPath . '/AddCustomer2.php?UpdateCustomerCode='.$myrow['customer_code'] .'&file_name=' . $myrow['file_name'] . '&creation_date='.$myrow['creation_date'].'&file_patch='.$myrow['file_patch'].'" >删除</td>
...
// <td><a href="' . $RootPath . '/Quote3.php?New=Yes&Updateorder_number=' . $myrow['file_patch'] . '">预览</td>
       echo '
             ...
             <td>' . $myrow['created_by'] . '</td>
             <td><a href="' . $RootPath . '/' . $myrow['file_patch'] . '" target="_blank">' . '下载' . '</td>
             <td><a href="' . $RootPath . '/AddCustomer2.php?UpdateCustomerCode='.$myrow['customer_code'] .'&file_namea=' . $myrow['file_name'] . '&creation_date='.$myrow['creation_date'].'&file_patch='.$myrow['file_patch'].'" >删除</td>
