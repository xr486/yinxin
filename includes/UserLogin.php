...
/* $Id: UserLogin.php 6184 2013-08-06 07:06:19Z icedlava $*/
...
function userLogin($Name, $Password, $SysAdminEmail = '', $db) {
	...
	/* if not logged in */
		...
		if (DB_num_rows($Auth_Result) > 0) {
			...
			$_SESSION['SaleFlag'] = $myrow['sale_flag'];
			$_SESSION['DepartCode'] = $myrow['depart_code'];
			$_SESSION['CanCreateTender'] = $myrow['cancreatetender'];
			$_SESSION['AllowedDepartment'] = $myrow['department'];
			$_SESSION['price_flag'] = $myrow['price_flag'];
			$_SESSION['dingdingUserID'] = $myrow['dingdingUserID'];
