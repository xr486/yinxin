...
$msg = '其它收入申请单'.$OrderNum.'建立成功！';
                prnMsg($msg, success);
                 echo '<br /><div class="centre"><a href="' . $RootPath . '/ExpInCreate.php?New=Y">' . _('继续创建其它收入申请单') . '</a></div>';
		...
		<img src="' . $RootPath . '/css/' . $Theme . '/images/supplier.png" title="' . '为其它收入申请单上传附件' .
 '" alt="" />' . ' ' .'为其它收入申请单上传附件' . '
	</p>';
