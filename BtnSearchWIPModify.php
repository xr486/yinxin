...
$count = db_sql("SELECT  a.plan_start_date , 
            ...
            WHERE  1=1 and a.primary_item=b.item_no and a.status_type='开始' 
			and wip_entity_name in (select wip_entity_name from wip_material_requierments where 1=1)   ".$where."",3);
...
$sql = "SELECT  a.plan_start_date , 
			...
			FROM wip_jobs_all a ,sf_item_no b
            WHERE  1=1 and a.primary_item=b.item_no and a.status_type='开始' 
			and wip_entity_name in (select wip_entity_name from wip_material_requierments where 1=1)  ".$where."  ORDER BY a.wip_entity_name  desc limit ".$off.",".$num;
