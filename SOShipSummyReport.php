...
{
  $sql ="SELECT  
                 d.customer_code,b.customer_flag,
                 c.customer_name,
	             b.stockid,
	             b.item_name,
	             b.item_desc,
			     a.uom ,
				 sum(a.shiped_quantity)  shiped_quantity
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('出货汇总报表处理') . '</p>';
