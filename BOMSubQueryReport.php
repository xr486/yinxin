...
if (isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    $sql = "SELECT a.bom_header_id,a.version,a.assembly_item_no,b.item_name,b.item_desc,a.creation_date,a.created_by,item_category1,b.gongyi
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('查询BOM及替代料') . '</p>';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    ...
    echo '<div class="hier-toolbar"><span class="version-tag">BOM及替代料查询结果</span></div>';
    ...
    echo '<tr>
                    ...
                    <th class="ascending"width = 90>' . _('分类') . '</th>                   <th class="ascending"width = 160>' . _('建立日期') . '</th>
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> $_SESSION['DisplayRecordsMax'] )) {
            ...
            echo '  <td><a href="' . $RootPath . '/BOMSubQueryReport2.php?searchitem_no=' . $myrow['bom_header_id'] . '" target="_blank">' . $myrow['assembly_item_no'] . '</td>			                
