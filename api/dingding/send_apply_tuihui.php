...
$conn = db_connect();
//获取基本数据
require_once('basic_data_tuihui.php');
// // 发起人id
...
if (json_last_error() === JSON_ERROR_NONE) {
    ...
    $CustomerCode = $data['CustomerCode'];//客户代码
    $return_type = $data['return_type'];//类型
    $return_reason = $data['return_reason'];//退/换货原因
    $tracking_number = $data['tracking_number']; //运单号
    $problem_class = $data['problem_class']; //问题分类
    $subinventory_code = $data['$subinventory_code'];//仓库原因
