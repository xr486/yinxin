...
$where .= " and a.enable_flag='Y' ";

$num = 10;
$off = $num*($page-1);
 
$count = db_sql('select a.* from vendors a,tax_set b where a.tax_code=b.tax_name  and  a.vendor_status = "已签核" '.$where.'',3);

$pages = ceil($count/$num);
$sql = 'select a.*,b.tax_mount from vendors a,tax_set b where a.tax_code=b.tax_name and  a.vendor_status = "已签核" '.$where.' ORDER BY vendor_code  limit '.$off.','.$num.'';
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./BtnSearchVendor3.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
					...
					<tr>
						<th class="ascending" width ="100"> 供应商编号 </th>
