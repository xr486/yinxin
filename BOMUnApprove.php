...
if (isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    $sql = "SELECT bom_header_id,a.assembly_item_no,b.item_name,b.item_desc,a.creation_date,a.created_by,b.gongyi,a.status
	FROM bom_headers_all a,
	 sf_item_no b
WHERE	1 = 1
AND b.item_no = a.assembly_item_no and a.status = '已签核'
";
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    ...
    echo '<tr>
			...
			<th class="ascending"width = 100>' . _('工艺') . '</th>                   
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> 15 )) {
            ...
            echo '  <td><a href="' . $RootPath . '/BOMUnApprove2.php?searchitem_no=' . $myrow['bom_header_id'] . '" target="_blank">' . $myrow['assembly_item_no'] . ' </td>
