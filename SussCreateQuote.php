...
$msg = '报价申请编号'.$_SESSION['OrderNum' . $identifier].'建立成功！';
                prnMsg($msg, success);
                 echo '<br /><div class="centre"><a href="' . $RootPath . '/QuoteRequest.php?New=Y">' . _('继续创建报价申请') . '</a></div>';
...
$sql = "insert into quote_headers_all_file (file_name,order_number,file_patch,creation_date,created_by) values ('".$_POST['file_name']."','".$_POST['OrderNum1']."','".$dest."','".$time."','".$_SESSION['UserID']."')";
