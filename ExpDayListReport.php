...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    $sql = "select * from ( SELECT s.transaction_num,s.transaction_amount,s.dis_amount,s.tax_amount,s.transaction_date,s.bankchangenum,s.currency_code,s.transaction_type,b.customer_code,b.customer_name,a.bankaccountname,a.bankaccount
     FROM
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
   ...
   echo '<tr>
                    ...
                    <th class="ascending"width = 120>' . _('交易对象') . '</th>   
                    <th class="ascending"width = 120>' . _('交易对象') . '</th>  
                    ...
                    <th class="ascending"width = 100>' . _('优惠金额') . '</th> 
                    <th class="ascending"width = 100>' . _('税额') . '</th>   
            </tr>';
