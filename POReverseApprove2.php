...
if (isset($Updatepo_num) and $Updatepo_num != '') {
    //CreditLimit,
    $sql = "SELECT a.po_num, a.status,order_type,a.note, a.order_date, a.creation_date, a.po_all_amount,a.all_line_amount,a.tax_amount,a.app_remark, b.vendor_name, a.vendor_code, a.tax_flag,a.created_by,a.po_all_amount,a.youhui_amount,a.payment_type,a.tax_name,a.payment_term,a.tax_name
FROM po_headers_all a, vendors b
WHERE 1 =1 and status in( '已签核' )
...
AND po_num ='" . $Updatepo_num . "'";
    ...
    if (!isset($_GET['delete'])) {
        ...
        echo'
				...
				<input type="text" name="po_all_amount" readonly="readonly" value="' .  sprintf("%.2f",$_POST['po_all_amount']) . '" /></div>
                ...
                <input type="text" pattern="^[^?.\+<>!&’:,;?$\^]+$" name="app_remark" value="' . $_POST['app_remark']. '" size="35" maxlength="45"/></div>
        ...
        echo '</table>';
        echo '<br />';
        $sql2 = "SELECT a.po_num,a.line,a.stockid,b.item_name,b.item_desc,(select locationname from  locations ll where ll.loccode=a.subinventory_code) subinventory_code,a.uom,a.quantity,a.price,a.last_price,a.line_amount,a.line_remark,a.creation_date,a.created_by
                  FROM po_lines_all a,sf_item_no b
                 where a.stockid=b.item_no and 1=1 and po_num = '" . $Updatepo_num . "'";
   ...
   if ($_POST['status'] == '已签核')
        echo '<br />
          <input type="submit" name="Submit" value="' . "审核撤销" . '" /> &nbsp;&nbsp;&nbsp;&nbsp;     <input type="submit" name="return" value="' . "返回上一层" . '" />&nbsp;
...
if (isset($_POST['Submit'])) {
    ...
    $msg = '签核成功！1秒后将跳转上一页！';
    prnMsg($msg, 'success');
    echo '<meta http-equiv="refresh" content="1; url=' . $RootPath . '/POReverseApprove.php" />';
    echo '<br />';
    echo '<br /><div class="centre"><a href="' . $RootPath . '/POReverseApprove.php">' . _('采购单审核撤销') . '</a></div>';
...
if (isset($_POST['return'])) {
    header('Location: POReverseApprove.php');
}
