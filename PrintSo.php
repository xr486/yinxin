...
$sql4= "SELECT  d.bank_name,d.bank_account,d.coyname_en,d.coyname,order_number,a.customer_code,need_date,a.creation_date, a.created_by, b.customer_name,a.subject,a.project,b.customer_contacts,b.contacts_phone,b.contacts_fax,b.currency_code,c.employee_name,c.telephone,c.email ,a.term_name,a.jiaohuotiaojian,a.baozhuang,a.zhiliangbaozheng,a.mainfeifuwu,a.yunfei
FROM so_headers_all a, customers b,hr_employees c,companies2 d  WHERE a.coycode=d.coyname_code
and c.employee_num =a.yewu AND a.customer_code = b.customer_code  
  ...
  <td><?php echo $myrow4['subject'];?> <br/></center></td>
   ...
   <!--  <span><center><h3>Suzhou &nbsp; East &nbsp; Dragon  &nbsp;FIFE  &nbsp;CO,LTD. </h3></center></span>
    ...
    <div class="tab">
     ...
     <?php 	 	
  $sql2 = "SELECT c.line,c.quantity,c.price,uom,c.line_amount,c.leixing,c.need_remark				
...
?>
    ...
    <!-- <HR width="100%"  color="black" SIZE=1/> -->
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="text-align:left;" width="20" ><center>项目</td> 
                 <td style="text-align:left;"  width="180"><center>类型 </center></td>
                 <td style="text-align:left;"  width="280"><center>需求 </center></td>
			 ...
			 <tr>
				...
				<td style="text-align:left;"  ><center>Type </center></td> 
				<td style="text-align:left;"  ><center>Need </center></td> 
		...
		<tr>
				...
				<td style="text-align:left;" ><center><?php echo $myrow2['need_remark']   ;?></center></td>
              ...
              <tr>
				...
				<tr>
                <td style="text-align:left;" ><center><?php echo $line;?><br/></center></td>
				<td style="text-align:left;" "><center>税金或关税：13%增值税 </center></td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="40%" colspan="2">付款帐户资料/Bank Details：</td> 
  </tr>
 <tr> 
     <td width="7%"></td>
    <td width="50%"> 账户名／Account Name： <?php echo $myrow4['coyname'];?></td>
  </tr>
  <tr> 
     <td width="7%"></td>
    <td width="50%">银行 / Bank：  <?php echo $myrow4['bank_name'];?></td>
  </tr>
   <tr> 
     <td width="7%"></td>
    <td width="50%">  账号 / Account Number ：  <?php echo $myrow4['bank_account'];?></td>
  </tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
 <tr> 
    <td width="50%">  <?php echo $myrow4['coyname_en'];?></td>
    <td width="50%">  Customer:<?php echo $myrow4['customer_name'];?></td>
  </tr>
  <tr> 
