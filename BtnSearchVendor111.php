...
$sql = 'SELECT d.* FROM vendors d WHERE  d.vendor_code in (SELECT a.vendor_code FROM po_headers_all a,po_lines_all b WHERE a.po_num = b.po_num AND b.quantity > b.quantity_received AND a.status = "APPROVED"  )'.$where.' ORDER BY vendor_code  desc limit '.$off.','.$num.'';
// echo $sql;
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./BtnSearchVendor111.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
	 ...
	 <div class="text-nav-1 ">
		 <div>供应商代号：
							...
							<input type="text"   autocomplete="off"   name="vendorcode" value="<?=$vendorcode?>"></div>
							<div class="text-nav-1 ">
		 <div>供应商名称：
						</div>
