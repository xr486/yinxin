...
WHERE
	1 = 1
AND a.customer_code = b.customer_code  AND a.status = 'INPROCESS'
";
...
// <th class="ascending"width = 70>' . _('打印') . '</th>
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> 15 )) {
            ...
            echo '  <td><a target="_blank" href="' . $RootPath . '/SearchSO2.php?Updateorder_number=' . $myrow['order_number'] . '">' . $myrow['order_number'] . '</td>
