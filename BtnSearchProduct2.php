                ...
                <table cellpadding="2" class="selection">
                    ...
                    if (@DB_num_rows($result) <> 0) {
                        ...
                        while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> 10)) {//$_SESSION['DisplayRecordsMax']
                            ...
                            <td><input name="a" type="radio" value="选择" class="coupons" rel="<?=$myrow['p_id']?>:<?= $myrow['p_name'] ?>">		</td>
                            </tr>
                            <?php
                            $i++;
                            $RowIndex++;
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            function ok()
            {
                switch ($('#cat').val()){
                    case 'buliao':
                        W.document.getElementById('text_slect_buliao'+$('#fwValue').val()).value = $("label#form_id").text();
                        W.document.getElementById('text_slect_units'+$('#fwValue').val()).value = "个";
                        W.document.getElementById('text_slect_ItemDesc'+$('#fwValue').val()).value = $("label#form_ItemNo").text();
