...
unset($result);
 ...
 DB_Txn_Begin($db);
    ...
    $_SESSION['lastsearchtime'] = $time;
		   ...
		   header("Location: SussCreate.php?OrderNum=".$invoice_name."&type=APInvoice1");
...
<div id="CanvasDiv">
    <div id="BodyDiv">
        <div id="BodyWrapDiv">
            <p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="供应商发票录入处理" alt="供应商发票录入处理">供应商发票录入处理</p>
...
?>
  ...
  <div>发票号码:</div>
    ...
    <div class="centre">
        <input type="submit"  name="Hearder" value="确认采购发票头信息">
        <?php

// echo '&nbsp;&nbsp;
//   <a href="' . $RootPath . '/APInvoiceUpload.php">批量上传</a></div>';
?>
...
<input type="hidden" class="text"  name="this_invoice_amount" id="this_invoice_amount2" value="<?=$_POST['this_invoice_amount'.$i]?>" />
			  ...
			  <div class="centre"> 
                    ...
                    <tr id="list-top">
                    <th bgcolor="#87CEFA" width="160">入库单</th>
                    <th bgcolor="#87CEFA" width="60">行</th>
                    <th bgcolor="#87CEFA" width="160">采购单</th>
                    <th bgcolor="#87CEFA" width="60">行</th>
                    <th bgcolor="#87CEFA" width="160">料号</th>
                    <th bgcolor="#87CEFA" width="160">料号名称</th>
                <th bgcolor="#87CEFA" width="10">对账金额</th>
                    <th bgcolor="#87CEFA" width="10">已开票金额</th>
                    <th bgcolor="#87CEFA" width="10">未开票金额</th>
                    <th bgcolor="#87CEFA" width="100">本次开票金额</th> 
                    ...
                    <!--采购单号-->
                    <td><input type="text"  style="background-color:#D2E9FF;" name="receipt_num<?=$i?>" id="text_slect_receipt_num<?=$i?>" value="<?=$_POST['receipt_num'.$i]?>" size="12" maxlength="25"/>
                      <image class="select_img" src="img/search.png" id="btn_slect_buliao<?=$i?>"/>
                    </td>
					 <td><input type="text"  style="background-color:#D2E9FF;" name="receipt_line<?=$i?>" id="text_slect_receipt_line<?=$i?>" value="<?=$_POST['receipt_line'.$i]?>" size="2" maxlength="25"/> 
					 ...
					 <td><input type="text"  style="background-color:#D2E9FF;" name="po_line<?=$i?>" id="text_slect_po_line<?=$i?>" value="<?=$_POST['po_line'.$i]?>" size="2" maxlength="25"/> 
					 <td><input type="text"  style="background-color:#D2E9FF;" name="item_no<?=$i?>" id="text_slect_item_no<?=$i?>" value="<?=$_POST['item_no'.$i]?>" size="12" maxlength="25"/> 
					 <td><input type="text"  style="background-color:#D2E9FF;" name="item_name<?=$i?>" id="text_slect_stockid<?=$i?>" value="<?=$_POST['item_name'.$i]?>" size="20" maxlength="25"/> 
                    </td>  	
                    <!--采购单行号 -->
     
                        <td><input type="text" class="number"  readonly="readonly" id="text_slect_check_amount<?=$i?>" name="check_amount<?=$i?>" value="<?=$_POST['check_amount'.$i]?>" size="7" maxlength="10"/></td>
                        ...
                        <td><input onblur="checkall()" onkeyup="checkweight(<?=$i?>)" style="background-color:#D2E9FF;" class="number" id="add_this_invoice_amount<?=$i?>" 
...
function  checkweight(s1){
	    var invoice_amount=document.getElementById("add_this_invoice_amount"+s1).value;
	    var wait_amount=document.getElementById("text_slect_wait_amount"+s1).value; 
        if(parseFloat(invoice_amount) <=0 ){
			alert('开票金额不可以小于0！');
         
            document.getElementById("add_this_invoice_amount"+s1).value="";
            document.getElementById("add_this_invoice_amount"+s1).focus();
        } else if(parseFloat(wait_amount) <  parseFloat(invoice_amount)  ){
			alert('开票金额不可以小于待开票金额！'); 
            document.getElementById("add_this_invoice_amount"+s1).value="";
            document.getElementById("add_this_invoice_amount"+s1).focus();
        }  
