...
$component_item     = isset($_REQUEST['component_item']) ? $_REQUEST['component_item'] : 1;
...
if($cat) {
   ...
   $where .= "and   item_no not in (select substitute_item from bom_substitutes_all where   component_sequence_id =   '". $cat . "' ) "; 
...
if($component_item) {
   ...
   $where .= "and   item_no <>  '". $component_item . "' "; 
...
$sql = 'select * from sf_item_no where 1=1 '.$where.' ORDER BY item_no  desc limit '.$off.','.$num.'';
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./Searchitemforbom.php?fwValue=<?=$cat?>&cat=<?=$cat?>&component_item=<?=$component_item?>" method ="POST">
				<div>
					...
					<br/>
					<div class="centre">
					<?=show_page('?page=',$page,$pages,$count,'&fwValue='.$cat.'&cat='.$cat.'&component_item='.$component_item.'&ItemNo='.$ItemNo.'&ItemDesc'.$ItemDesc.'');?>
		...
		<div id="FooterWrapDiv">
                   ...
                   <div style="display:none">
                    ...
                    <div style="display:none">
                        ...
                        <p><input type="hidden" name="component_item" id="component_item" value="<?=$component_item?>"/></p>
