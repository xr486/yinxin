...
FROM
    ...
    $sql .= " order by a.item_no,a.creation_date "; 
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('查找库存修改记录') . '</p>';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    echo '<tr>
                    <th class="ascending" width = 100>' . _('料') . '</th>
                    <th class="ascending"width = 80>' . _('长') . '</th>
                    <th class="ascending"width = 80>' . _('长') . '</th>
                    <th class="ascending"width = 120>' . _('数量') . '</th>
                    <th class="ascending"width = 280>' . _('描述') . '</th>
                     <th class="ascending"width = 170>' . _('修改时间') . '</th>
            </tr>';
