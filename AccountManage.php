...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('客户对账处理：选择客户') . '</p>';
...
//            echo '<br /><div class="centre">&nbsp;&nbsp;' . $_POST['PageOffset'] . ' ' . _('of') . ' ' . $ListPageMax . ' ' . _('pages') . '. ' . _('Go to Page') . ': ';
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> 20)) {
			...
			echo '  <td><a href="' . $RootPath . '/AccountCheck.php?New=Yes&customer_id=' . $myrow['customer_id'] . '">' . $myrow['customer_code'] . '</td>
