...
<div id="BodyDiv">
<div id="BodyWrapDiv">
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="供应商红字发票审核" alt="供应商红字发票审核">供应商红字发票审核</p>
...
a.invoice_amount, b.vendor_name,b.vendor_code,a.tax_amount,a.dis_amount,a.ap_invoice_type,a.tax_code
...
$sql ="select invoice_line,a.po_num,c.amount,c.dis_amount,a.invoice_amount,a.dis_invoice_amount,c.remark,a.po_all_amount
 ...
 echo '<br /><div class="text-nav-table"> 
    ...
    echo '<tr> 	  <th   >' . _('行') . '</th>                 
					...
					<th   width="100" >' . _('已开票金额') . '</th>
					<th   width="100" >' . _('未开票金额') . '</th>
					  <th  >' . _('本次开票金额') . '</th> 
