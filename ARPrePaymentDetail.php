...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    $sql = 'select ah.receivenum,ah.receiveamount,ah.taxamount,ah.receivedate,ah.narrative ,ah.customer_code,ve.customer_name,ah.bankchangenum,ah.currency_code,ah.bankaccountname,ah.receive_type,ah.prereceive_used,ah.creation_date 
