...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    $sql = 'select * from inv_check_headers_all b    where 1=1
	  ';
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('查找盘点单据') . '</p>';
...
echo '</div></table><div class="centre"><input type="submit" name="Search" value="查找"> &nbsp;&nbsp;<input type="submit" name="add_new" value="新增盘点单"></div>';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> 50)) {
			...
			echo '  <td><a href="' . $RootPath . '/InvCheckReport2.php?Updatecheck_num=' . $myrow['check_num'] . '">' . $myrow['check_num'] . '</td>
				...
				<td>' . $myrow['approve_remark'] . '</td>
				<td><a href="' . $RootPath . '/InvCheckReport3.php?Updatecheck_num=' . $myrow['check_num'] . '" target="_blank">打印</td>
				<td><a href="' . $RootPath . '/InvCheckReport4.php?Updatecheck_num=' . $myrow['check_num'] . '" target="_blank">打印</td>
				';
