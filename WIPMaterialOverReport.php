...
if (isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    $sql = " select d.item_no mitem_no,d.item_name mitem_name,a.plan_start_date,a.so_header_number,a.so_line_number,b.segment1,c.item_desc,c.item_name,b.comments,quantity_issued,b.required_quantity,
	a.wip_entity_name,b.quantity_per_assembly,b.operation_seq_num,b.chaohao_quantity
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
    ...
    echo '<tr>       <th bgcolor="#87CEFA"    >' . _('工单号') . '</th> 
	 <th bgcolor="#87CEFA"    >' . _('产品料号') . '</th> 
	  <th bgcolor="#87CEFA"    >' . _('产品名称') . '</th> 
					...
					<th bgcolor="#87CEFA"  width = 70>' . _('超耗量') . '</th>
    ...
    if (isset($ListPageMax) AND $ListPageMax > 1) {
	 ...
	 echo '<br>
          <div class="centre">
                <a href="' . $RootPath . '/WIPMaterialOverReportExcel.php?wip_entity_name=' .$_POST['wip_entity_name'] . '">
                ' .'资料导出Excel表' . '
                </a>
          </div>';
}
