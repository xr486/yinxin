...
$_SESSION['OrderNum' . $identifier]=$_GET['OrderNum'];
                  ...
                  echo '<br /><div class="centre"><a href="' . $RootPath . '/ExpInModify.php?New=Y">' . _('继续创建申请单') . '</a></div>';
		...
		<img src="' . $RootPath . '/css/' . $Theme . '/images/supplier.png" title="' . '为申请单上传附件' .
 '" alt="" />' . ' ' .'为申请单上传附件' . '
	</p>';
