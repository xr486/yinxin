...
$sql = "select a.*, b.item_name, b.item_desc, b.gongyi from bom_headers_all a, sf_item_no b  where a.assembly_item_no = b.item_no";
...
if (isset($_POST['Search']) or isset($_POST['Go']) or isset($_POST['Next']) or isset($_POST['Previous'])) {
    ...
    if (isset($_POST['assembly_item_no']) and $_POST['assembly_item_no'] != '') {
            $sql = $sql . " and a.assembly_item_no " . LIKE . " '%" . $_POST['assembly_item_no'] . "%' ";
    }
...
echo '<input type="text" id="text_slect_name" name="item_desc" value="' . $_POST['item_desc'] . '" size="20" maxlength="250" /></div>';
echo '<div class="text-nav-1 "><div>' . _('工艺') . ':</div>';
echo '<input type="text" name="gongyi" value="' . $_POST['gongyi'] . '" size="20" maxlength="250" /></div>';
...
if (isset($_POST['Search']) or isset($result) or isset($_POST['Go']) or isset($_POST['Next']) or isset($_POST['Previous'])) {
        ...
        if (DB_num_rows($result) <> 0) {
                ...
                while (($myrow = DB_fetch_array($result)) and ($RowIndex <> $_SESSION['DisplayRecordsMax'])) {
                        ...
                        echo '  
                            <td><a href="' . $RootPath . '/ECNSetup2.php?New=Yes&OrderNum=' . $myrow['assembly_item_no'] . '">' . $myrow['assembly_item_no'] . '</td>
