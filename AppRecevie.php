		...
		if ($errorflag == 0) {
			...
			foreach ($_POST as $key => $value) {
				if ($value != '') {
					if (substr($key, 0,7)=='stockid') {
						...
						values('".$_POST['invoicenum']."','".$i."','".$_POST['customercode']."','".$_POST['delivery_num'.$i]."','".$_POST['deliveryline'.$i]."',
						'".$_POST['this_amount'.$i]."','".$_POST['so_order_number'.$i]."','".$_POST['so_line_no'.$i]."',
			...
			$sql = "insert into ar_invoice_headers_all
                                         (ar_invoice_type,invoicenum,invoiceamount,
                                            ...
                                            created_by,
                                            last_update_date,
                                            last_updated_by) values ('".'应收款立账'."','".$_POST['invoicenum']."','".$_POST['invoiceamount']."','".$_POST['taxamount']."','".$_POST['customercode']."','".$_POST['Header_Remark']."','".$_POST['currency_code']."','".$Delivery_date."','".$schedulereceivedate."','".$time."','".$_SESSION['UserID']."','".$time."','".$_SESSION['UserID']."')";
			$result = DB_query($sql,$db);
...
<div id="CanvasDiv">
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="客户开票立账处理" alt="客户开票立账处理">客户开票立账处理</p>
