...
$count = db_sql('select * from vendors where vendor_status = "已签核" '.$where.'',3);

$pages = ceil($count/$num);
$sql = 'select * from vendors where vendor_status = "已签核" '.$where.' ORDER BY vendor_code  limit '.$off.','.$num.'';
