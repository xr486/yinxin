...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous']))
{
     ...
     $sql ="SELECT  a.*,b.customer_name from so_qc_bad_all a,customers b where a.customer_code = b.customer_code ";
  ...
  if (DB_num_rows($result) <> 0) 
  {
    ...
    while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> $_SESSION['DisplayRecordsMax'])) 
	{
	 ...
	 //  htmlspecialchars_decode(),转换为html格式直接输出
      ...
      echo '<td><a target="_blank" href="' . $RootPath . '/ProblemFeedbackReportfile.php?OrderNum=' . $myrow['lianluodan']  . '">附件' . $myrow2['count'] . '</td>  
