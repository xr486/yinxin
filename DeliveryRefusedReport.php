...
//  ";
    $sql = " SELECT delivery_num,status,delivery_date,b.customer_code,delivery_amount,a.creation_date,narrative,a.created_by,b.customer_name  FROM so_delivery_headers_all a, customers b  WHERE 1 = 1 AND a.customer_code = b.customer_code AND a.status = 'INPROCESS' ";
 ;
// echo $sql;
...
// var_dump($myrow);
            echo '  <td><a href="' . $RootPath . '/DeliveryRefusedReport2.php?Updatedelivery_num=' . $myrow['delivery_num'] . '">' . $myrow['delivery_num'] . '</td>
                <td>' . $v_status . '</td>
