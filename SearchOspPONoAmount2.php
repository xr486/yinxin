...
AND waixie_num= '" .$Updatewaixie_num."'";
    ...
    if (!isset($_GET['delete'])) {
        ...
        $sql2 = "SELECT a.waixie_line,a.line,a.po_line_id,a.order_number,a.uom,a.price,a.quantity,a.waixie_num,a.line_amount,a.operation_code,a.need_remark,gongshi,a.creation_date,
            ifnull(quantity_deliveried,0) quantity_deliveried,ifnull(quantity_cancelled,0) quantity_cancelled,ifnull(quantity_rejected,0) quantity_rejected,ifnull(quantity_billed,0) quantity_billed,
            a.created_by,(select locationname from locations d where d.loccode=a.subinventory_code) locationname,a.need_date
