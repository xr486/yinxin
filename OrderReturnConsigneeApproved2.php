...
if (isset($_POST['Reject'])) 
{
  ...
  $sql = "update  so_delivery_headers_all
    ...
    echo "<script>location.href='OrderReturnConsigneeApproved.php';</script>";
 ...
 if (isset($_POST['Agree'])) 
{
  ...
  if ($errorflag == 0) 
  {
    $Delivery_date = strtotime($_POST['Delivery_date']);
		...
		$sql = "update  so_delivery_headers_all
                    set  status='待仓库审核' ,
                    shouhuo_approve_date='".$time."' ,
                    shouhuo_approved_by  ='".$_SESSION['UserID']."'
...
<div id="BodyDiv">
<div id="BodyWrapDiv">
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="收货人审核" alt="收货人审核">收货人审核</p>
