...
if($cat) {
   ...
   $where .= "and   item_no not in (select component_item from bom_lines_all where   assembly_item_no =   '". $cat . "' ) "; 
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./Searchitemforbom2.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
