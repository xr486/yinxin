...
if (isset($_POST['Reject'])) 
{
    ...
    if ($errorflag == 0) 
    {
        ...
        DB_Txn_Commit($db);
        prnMsg('工单领料部门拒绝完成',success);
        //echo "<script>location.href='index.php';</script>";
        header("Location: WIPIssueDepartApproved.php");
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('工单领料部门审核') . '</p>';
