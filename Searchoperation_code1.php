				...
				<div>
					...
					<tr class="EvenTableRows">
						...
						<td> <?=$row2['remarks']?>
							...
							<td>
						<input name="a" type="hidden" class="coupons" value="<?=$row2['operation_code']?>:<?=$row2['remarks']?>:<?=$row2['operation_seq_num']?>
						">				 
						</td>
					...
					<br/>
					<div class="centre">
					<?=show_page('?page=',$page,$pages,$count,'&fwValue='.$cat.'&cat='.$cat.'&operation_code='.$operation_code.'&remarks'.$remarks.'');?>
