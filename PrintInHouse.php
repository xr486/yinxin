...
$sql5= "SELECT * FROM companies ";
 ...
 $sql = "SELECT distinct a.transaction_date,a.wip_entity_name,c.depart_code,a.creation_date,c.realname,a.subinventory_from,a.trans_num,(SELECT realname from www_users d where d.userid = a.sub_approved_by ) sub_realname,a.sub_approve_date  FROM inv_transactions_all_temp a, www_users c where  a.created_by = c.userid and a.trans_num = '" .$Updatedelivery_num."' ";
        //  echo $sql;
