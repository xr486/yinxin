...
$sql ="SELECT  a.receipt_line_id,a.receipt_num,a.receipt_line,a.uom,
a.unit_price,a.transaction_quantity,a.check_quantity,a.check_price,a.check_amount,a.check_date,a.remark, 
a.creation_date,a.stockid,b.delivery_date,b.vendor_code,d.vendor_name, a.po_num,a.po_line,b.receipt_type,g.item_name
from po_rcv_receipt_line a, po_rcv_receipt_header b, 
vendors d,po_lines_all e,sf_item_no g,po_headers_all c
where a.receipt_num = b.receipt_num  and e.stockid=g.item_no 
and b.vendor_code = d.vendor_code
and a.check_flag='Y'  and a.po_line=e.line and a.po_num=e.po_num  and c.po_num=e.po_num and c.order_type = '外协采购'	 	
";
...
echo '
        ...
        //   <a href="' . $RootPath . '/OspPOCheckWaitedDeliveryExcel.php?order_number=' .$_POST['order_number'] .'&po_num=' .$_POST['po_num'] .'&vendor_name=' .$_POST['vendor_name'] . '&FromDate=' .$_POST['FromDate'] .'&ToDate=' .$_POST['ToDate'] . '&FromDate2=' .$_POST['FromDate2'] .'&ToDate2=' .$_POST['ToDate2']  .' ">' .'导出' . '</a>
        //   </div>';
          echo ' </div>
';
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('外协采购已对账报表') . '</p>';
