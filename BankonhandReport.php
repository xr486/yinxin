...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
	...
	if (isset($_POST['bankname']) and $_POST['bankname'] != '') {
        $sql = $sql . " and  bankname " . LIKE . " '%" . $_POST['bankname'] ."%' ";
    }
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('账号余额查询') . '</p>';
echo '<table cellpadding="3" class="selection">';

echo '<td >' . _('账户名称') . ':</td><td>';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    echo '<tr>
                    <th class="ascending"width =150>' . _('账户名称') . '</th>
                    <th class="ascending"width = 150>' . _('账号') . '</th>
                    <th class="ascending"width = 250>' . _('开户行名称') . '</th>
					<th class="ascending"width = 250>' . _('开户行地址') . '</th>        
                    <th class="ascending"width = 50>' . _('币别') . '</th>
                
                    <th class="ascending"width = 150>' . _('余额') . '</th> 
