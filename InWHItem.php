...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('仓库库存汇总查询') . '</p>';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    echo '<tr>
					...
					<th bgcolor="#87CEFA" class="ascending"width = 100>' . _('提示') . '</th>
...
//	  ';
		...
		echo '<div>
            <a href="' . $RootPath . '/InWHItemExp.php?item_no=' .$_POST['Stockid_from'].'&item_name='.$_POST['item_name'] .
