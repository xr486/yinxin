...
if(isset($_POST['customer_code']) and $_POST['customer_code'] != ''){
 ...
 if($_POST['checkresult']!=""){
        if($_POST['checkresult']=="1"){
            $sql .= " and ch.prereceive_used = ch.ReceiveAmount ";
        }
        if($_POST['checkresult']=="2"){
             $sql .=" and ch.prereceive_used <  ch.ReceiveAmount  and ch.prereceive_used > 0  ";
        }
        if($_POST['checkresult']=="3"){
             $sql .= " and ch.prereceive_used = 0 ";
        }
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('客户预收款明细查询') . '</p>';
echo '<table cellpadding="3" class="selection">';
echo '<tr><td  >' . _('输入部分客户名称') . ':</td><td>';
