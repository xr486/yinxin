...
$sql5= "SELECT * FROM companies ";
 ...
 $sql = "SELECT c.*,d.realname,d.depart_code, b.item_name,b.item_desc,a.start_quantity,(SELECT realname FROM www_users WHERE userid=c.sub_approved_by) sub_approved_by_realname
    FROM  inv_transactions_all_temp c ,www_users d,wip_jobs_all a,sf_item_no b
        where   c.trans_num = '" .$Updatedelivery_num."' and d.userid=c.created_by and c.wip_entity_name=a.wip_entity_name and a.primary_item = b.item_no
         ";
...
<p class="p2">领料单</p>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
            <td width="160"  style="text-align:right;">生产任务单号：</td>
            <td><?php echo $myrow['wip_entity_name'];?></td>
            <td width="240"  style="text-align:right;">物料名称/规格型号：</td>
            <td><?php echo $myrow['item_name'] .'/'. $myrow['item_desc'];?></td>
        </tr>
        <tr>
            <td style="text-align:right;">工单生产数量：</td>
            <td><?php echo $myrow['start_quantity'];?></td>
        ...
        <tr>
            ...
            <td style="text-align:right;"> 领料日期：</td>
     ...
     <?php
  $sql2 = "SELECT a.subinventory_from, a.item_no, ABS(a.quantity) quantity,b.item_name,b.item_desc,b.sub_locator,b.units,a.lot_num,a.creation_date,(SELECT realname FROM www_users WHERE userid=a.created_by) realname
  FROM  inv_transactions_all_temp a ,sf_item_no b
      where a.item_no = b.item_no and a.transaction_type ='工单领料'   and a.trans_num = '" .$Updatedelivery_num."' 
       ";
		// ECHO  $sql2;
...
?>
    ...
    <table width="100%"  cellpadding="0" cellspacing="0" class="content_tab" >
        ...
        <tr>
            ...
            <th style="text-align:left;" width="72"><center> 领用数量 </center></th>  
            <th style="text-align:left;" width="72"><center> 实发数量 </center></th>  
            <th style="text-align:left;" width="72"><center> 备注 </center></th>  
            <th style="text-align:left;" width="72"><center> 领料仓库 </center></th>  
		...
		<tr>
            ...
            <td style="text-align:left;"><center><?php echo $myrow2['quantity'];?></center></td>
            <td style="text-align:left;"><center><?php echo $myrow2['remark'];?></center></td>
    ...
    <tr>
        ...
        ?>
        <td width="40">发料人/日期：</td>
        <td width="72"><?php echo $myrow['sub_approved_by_realname'];?>   <?php echo $sub_approve_date;?></td>
      
    
    </tr>
    </table>
    <span>仓库（第一联）                生产（第二联）                    财务（第三联）</span>
