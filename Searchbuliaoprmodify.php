...
$count = db_sql("select a.*,(select price from po_vendor_item_price c where c.vendor_code='".$cat."' and c.item_no=a.item_no )  price
from sf_item_no a  where  1=1 ".$where."",3);

$pages = ceil($count/$num);
$sql = "select a.*,(select price from po_vendor_item_price c where c.vendor_code='".$cat."' and c.item_no=a.item_no )  price
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./Searchbuliaoprmodify.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
