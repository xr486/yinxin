...
//    $uploadflag == 0;
    if ($uploadflag == 1) {
        ...
        //$_POST['PicPath'] = "itempic/" . $_POST['mould_number'] .".jpg";
        $time = time();
...
VALUES
	(
		...
		'" . $_POST['remarks'] . "','" . $_POST['number_of_use'] . "','" . $_POST['product_number'] . "',
		'" . $time . "',
		'" . $_SESSION['UserID'] . "',
		'" . $time . "',
		'" . $_SESSION['UserID'] . "',
        ...
        $result = DB_query($sql, $db);
        prnMsg(_('新增成品模具建立成功！'), 'success');
        unset($_POST);
    }
}
?>
    <p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/maintenance.png" title="新增成品模具" alt="新增成品模具">新增成品模具</p>
        ...
        <div>
            ...
            <table class="selection">
                <tr>
                    ...
                    <td>模具图号：</td>
                    <td><input type="text" required="required" onblur="checknumber('mould_number')"  id="mould_number" name="mould_number"  ></td>
                ...
                <tr>
                    <td>模具芯盒数：</td>
                    <td><input type="text" required="required" onblur="check('mold_core_box_number')" id="mold_core_box_number" name="mold_core_box_number"  ></td>
                ...
                <tr>
                    ...
                    <td>对应成品料号：</td>
                    <td><input type="text"id="product_number"  readonly="readonly"  name="product_number" value="<?=$_GET['stockid']?>"  > </td>
                    <td>上传图片：</td>
                    <td><input type="file" name="Pic[]"  multiple="multiple"  ></td>
                </tr>
                <tr>
                    <td>备注：</td>
                    <td colspan="3"><input type="text" size="50" name="remarks" ></td>
                    <td>是否有效</td>
    ...
    <script type="text/javascript">
            $('#btn_slect_product').dialog({
                ...
                width: '950px',
                height: 470,
                content:'url:BtnSearchProduct.php?fwValue=&cat=buliao',
                init:function(){
