...
$count = db_sql("select s.order_number,s.line,s.stockid as item_no,s.price as unit_price,s.uom as units,i.item_desc,i.item_spec from  so_lines_all s,sf_item_no i where 1=1 and i.item_type='F' and s.stockid=i.item_no '".$where."''",3);

$pages = ceil($count/$num);
$sql = "select s.order_number,s.line,s.stockid as item_no,(select zhidao_price from bom_headers_all c where c.assembly_item_no=i.item_no)  as unit_price,s.uom as units,i.item_desc,i.item_spec from  so_lines_all s,sf_item_no i where 1=1 and i.item_type='F' and s.stockid=i.item_no '".$where."' ORDER BY s.order_number  desc limit '".$off."','".$num."''";
