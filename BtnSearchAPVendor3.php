...
$sql = 'select a.*,b.tax_mount from vendors a,tax_set b where a.tax_code=b.tax_name '.$where.' ORDER BY vendor_code  desc limit '.$off.','.$num.'';
//echo $sql;
$list = db_sql($sql,2);
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./BtnSearchAPVendor3.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
