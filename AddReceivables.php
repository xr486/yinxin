		...
		if ($errorflag == 0) {
			...
			$sql = "insert into ar_invoice_headers_all
                                         (invoicenum,invoiceamount,
                                            ...
                                            created_by,
                                            last_update_date,
                                            last_updated_by) values ('".$_POST['invoicenum']."','".$_POST['invoiceamount']."','".$_POST['taxamount']."','".$_POST['customercode']."','".$_POST['Header_Remark']."','".$_POST['currency_code']."','".$Delivery_date."','".$time."','".$_SESSION['UserID']."','".$time."','".$_SESSION['UserID']."')";
			$result = DB_query($sql,$db);
