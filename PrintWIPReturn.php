...
$sql5= "SELECT * FROM companies ";
 ...
 $sql = "SELECT c.*,d.realname,d.depart_code
...
<p class="p2">退料单</p>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
     ...
     <?php
  $sql2 = "SELECT a.subinventory_from, a.item_no, ABS(a.quantity) quantity,b.item_name,b.item_desc,b.sub_locator,b.units,a.lot_num,a.creation_date,a.created_by
  FROM  inv_transactions_all_temp a ,sf_item_no b
      where a.item_no = b.item_no and a.transaction_type ='工单退料'   and a.trans_num = '" .$Updatedelivery_num."' 
       ";
		// ECHO  $sql2;
...
?>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td >退料人/日期：<?php echo $myrow['realname'];?>   <?php echo date('Y-m-d',$myrow['creation_date']);?></td>
