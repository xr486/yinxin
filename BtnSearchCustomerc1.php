...
$where .= " and enable_flag='Y' and customers_status='已签核' ";
$num = 20;
$off = $num * ($page - 1);
...
from customers a where 1=1 ' . $where . ' ORDER BY customer_code  desc limit ' . $off . ',' . $num . '';
    ...
    <div id="CanvasDiv">
        ...
        <div id="BodyDiv">
            <div id="BodyWrapDiv">
                ...
                <form action="./BtnSearchCustomerc1.php?fwValue=<?= $cat ?>&cat=<?= $cat ?>" method="POST">
                    <div>
