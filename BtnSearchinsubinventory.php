...
<script type="text/javascript">
        $(document).ready(function(){           
            ...
            { 
                switch ($('#cat').val()){
                    case 'buliao':
                        W.document.getElementById('text_slect_inloccode'+$('#fwValue').val()).value = $("label#form_loccode").text(); 
					    W.document.getElementById('text_slect_insubinventoryname'+$('#fwValue').val()).value = $("label#form_name").text(); 
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./BtnSearchinsubinventory.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
					...
					<tr class="EvenTableRows">
						...
						<td>
						<input name="a" type="hidden" value="选择" class="coupons" rel="<?=$row2['loccode']?>:<?=$row2['locationname']?>">				 
						</td>
					</tr>
					<?php }?>
	...
	<div id="FooterDiv">
		<div id="FooterWrapDiv">
                   ...
                   <div style="display:none">
					 ...
					 <div style="display:none">
                         <p><label class="text-info">locationname</label>　<label id="form_name"></label></p>
                    </div>
