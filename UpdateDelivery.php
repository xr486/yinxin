...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])) {
   ...
   <tr>
                    <th class="ascending" width = 100>送货单号</th>
                    <th class="ascending"width = 70>状态</th>
                    <th class="ascending"width = 100>客户编号</th>
					 <th class="ascending"width = 250>客户名称</th>
                    <th class="ascending"width = 120>总额</th>                           
                    <th class="ascending"width = 200>备注</th>
                    <th class="ascending"width = 100>需求日期</th>
                    <th class="ascending"width = 180>送货单日期</th>
            </tr>
            <?
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ( $RowIndex <> 10 )) {
            ...
            echo '  <td><a href="' . $RootPath . '/UpdateDelivery2.php?New=Yes&Updatedelivery_num=' . $myrow['delivery_num'] . '">' . $myrow['delivery_num'] . '</td>
				<td>' . $v_status . '</td>
