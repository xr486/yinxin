...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    $sql = 'select item_no,item_desc,units,safe_qty  
from sf_item_no 
where 1=1 ';
...
//echo '<td><b>' . _('OR') . '</b></td><td>' . _('供应商代码') . ':</td>
//	<td>';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    echo '<tr>
                    ...
                    <th class="ascending"width = 150>' . _('料号描述') . '</th>
         
                    <th class="ascending"width = 250>' . _('安全库存') . '</th>
                
                    <th class="ascending"width = 250>' . _('单位') . '</th>
