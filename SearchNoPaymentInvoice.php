         ...
         window.onload=function(){
            ...
            ch_checked.onclick=function(){
				...
				$("#form_invoice_num").text(c[0]);
					...
					W.document.getElementById('text_slect_invoice_amount' + $('#fwValue').val()).value = $("label#form_amount").text();
		...
		<div id="BodyDiv">
			<div id="BodyWrapDiv">
				<p class="page_title_text">
					<img src="./css/xenos/images/magnifier.png" title="查询红字发票" alt="查询红字发票">查询红字发票
				</p>
				<form action="./SearchNoPaymentInvoice.php?fwValue=<?= $cat ?>&cat=<?= $cat ?>" method="POST">
					<div>
