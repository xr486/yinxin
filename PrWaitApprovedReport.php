...
$Title = _('待签核采购申请单明细查询');
$ViewTopic= '待签核采购申请单明细查询';
$BookMark = '待签核采购申请单明细查询';
...
$sql .=" order by a.creation_date desc,p.line";
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> $_SESSION['DisplayRecordsMax'])) {
			...
			//end of page full new headings if
                ...
                echo '</table>
                <a href="' . $RootPath . '/PrWaitApprovedReportExcel.php?item_desc=' . $_POST['item_desc'] . '&pr_num_from=' . $_POST['pr_num_from'] . '&depart_name=' . $_POST['depart_name'] . '&item_no=' . $_POST['item_no'] . '&FromDate=' . $_POST['FromDate'] . '&item_name=' . $_POST['item_name'] . '&ToDate=' . $_POST['ToDate'] . '">' . '资料导出Excel表' . '</a>
