...
$Title = _('其它收入/支出待主管审核');
$ViewTopic= '其它收入/支出待主管审核';
$BookMark = '其它收入/支出待主管审核';
...
/*
		...
		*/
		...
		prnMsg('其它收入/支出'.$_POST['transaction_num'].'待主管审核完成！',success);
...
<div id="BodyDiv">
<div id="BodyWrapDiv">
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="其它收入/支出待主管审核" alt="其它收入/支出待主管审核">其它收入/支出待主管审核</p>
