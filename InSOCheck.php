...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    $sql = "select distinct  a.order_id,a.order_number,a.created_by,a.man_contact,a.man_address,a.creation_date  from sf_orders_all a,sf_order_lines_all b WHERE  a.order_number=b.order_number and  b.status is null and b.start_work_flag='Y'";
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    echo '<tr>
                   ...
                   <th class="ascending"width = 250>' . _('建立时间') . '</th>
            </tr>';
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> 10)) {
			...
			echo '  <td><a href="' . $RootPath . '/SOCheck.php?NUM=' . $myrow['order_number'] . '">' . $myrow['order_number'] . '</td>
