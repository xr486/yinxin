...
if (isset($_POST['UpdateStatus']) ) {
    ...
    $time = time();
		...
		prnMsg('付款'.$_POST['invoice_num'].'执行完成！',success);
    echo "<script>location.href='APPaymentExecute.php';</script>";
...
<div id="BodyDiv">
<div id="BodyWrapDiv">
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="供应商付款执行" alt="供应商付款执行">供应商付款执行</p>
...
echo '<a name="end"></a><div class="centre"><input type="submit" name="UpdateStatus"   value="执行" />
