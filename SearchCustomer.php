...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    $sql = 'select customer_code,customer_name,customers_status,Customer_contacts,contacts_phone,contacts_mail,tax_name,contacts_fax,enable_flag,customer_type,creation_date  from customers   where 1=1';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    if (DB_num_rows($result) <> 0) {
        ...
        '&CustomerCode=' . $_POST['CustomerCode'] . '&CustomerContacts=' . $_POST['CustomerContacts'] . '&customer_type=' . $_POST['customer_type'] . '&contacts_fax=' . $_POST['contacts_fax'] . '&tax_name=' . $_POST['tax_name'] . '&enable_flag=' . $_POST['enable_flag'] .  ' ">' . '资料导出Excel表' . '</a>
            </div>';
	}
