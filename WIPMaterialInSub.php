...
<div id="CanvasDiv">
    <div id="BodyDiv">
        <div id="BodyWrapDiv">
            <p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="工单领料处理" alt="工单领料处理
">工单领料处理</p>
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>" method ="POST"><input type="hidden" name="time"
                ...
                <div>
                    ...
                    <table class="selection">
                        ...
                        <tr>
                            <td>工单名称：</td>
                            <td><input type="text" name="customercode" id="text_slect_customer" value="<?=$_POST['customercode']?>"/>
                                <a class="btn btn-info btn-xs" id="btn_slect_customer<?=$i?>" hfre="###" title="选择客户">选择</a> </td>

                            <td>料号名称：</td>
                            <td><input type="text" name="ScheduleDate"   value="<?=$_POST['ScheduleDate']?>"
                                       onfocus="WdatePicker() "></td>

                            <td>开工数量：</td>
                            <td><input readonly="readonly" type="text"   name="Address" id="text_slect_address" value="<?=$_POST['Address']?>"/></td>

                        </tr>
                        <tr>

                            <td>工单开工日期：</td>
                            <td><input type="text"   name="Header_Remark"  value="<?=$_POST['Header_Remark']?>"/> </td>
