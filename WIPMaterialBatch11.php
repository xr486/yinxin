...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/supplier.png" title="' . _('工单整批领料上传') .
 '" alt="" />' . ' ' . $Title . '</p>';
...
echo '<a href="' . $RootPath . '/WIPMaterialBatch2.php"><h3>' . _('进行上传资料确认界面') . '</h3>';
  
}  
 else  {	echo '<form action="WIPMaterialBatch.php" method="post" enctype="multipart/form-data">';
