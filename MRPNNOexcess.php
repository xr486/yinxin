...
$Title = _('非标材料多余料明细报表');
$ViewTopic = '非标材料多余料明细报表';
$BookMark = '非标材料多余料明细报表';
...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    $sql ="SELECT a.customer_code,c.order_number,c.line,c.item_no,c.item_name,c.item_description ,c.userd_per_quantity ,c.userd_quantity,c.uom,b.need_date,d.po_num po_number,e.line po_line,c.po_quantity,e.po_sch_receive_date
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('非标材料多余料明细报表') . '</p>';
