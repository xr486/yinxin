...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
 ...
 echo '<div>
                 <a href="' . $RootPath . '/WIPChangzhouReportExcel.php?customer_name=' .$_POST['customer_name'] .'&customer_code=' .$_POST['customer_code'] .'&FromDate=' .$_POST['FromDate'] . '&ToDate=' .$_POST['ToDate'] .'&item_no=' .$_POST['item_no'] . '&item_name=' .$_POST['item_name'] .'&wip_entity_name=' .$_POST['wip_entity_name'] . '&order_number=' .$_POST['order_number'] .' ">' .'资料导出Excel表' . '</a>
                </div>';
