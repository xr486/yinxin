...
/* $sql = "SELECT a.trans_num,a.transaction_type,c.item_no, a.uom, a.subinventory_from,a.request_person,d.loccode, d.locationname, (SELECT aa.employee_name
FROM hr_employees aa
WHERE a.request_person = aa.employee_num) employee_name, c.item_desc,c.item_name, a.quantity,a.creation_date,a.remark,a.transaction_date 
...
$sql = "SELECT a.trans_num,a.transaction_type,c.item_no, a.uom, a.subinventory_from,a.request_person,d.loccode, d.locationname, b.employee_num, (SELECT b.employee_name
FROM hr_employees b
WHERE a.request_person = b.employee_num) employee_name, c.item_desc,c.item_name, a.quantity,a.creation_date,a.remark,a.transaction_date 
...
if (isset($C11) and $C11 != '') 
{
   ...
   /* $sql = $sql . "group by a.transaction_type,c.item_no, a.uom, a.subinventory_from,a.request_person,d.loccode, d.locationname,   (SELECT aa.employee_name
FROM hr_employees aa
WHERE a.request_person = aa.employee_num),c.item_name, c.item_desc "; */
 //  echo $sql ;
...
$objFontA1->setName('宋体');          
$objFontA1->setBold(true); 
$objStyleA1 = $objActSheet->getStyle('L2');       
$objStyleA1->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);   
$objFontA1 = $objStyleA1->getFont();       
$objFontA1->setName('宋体');          
$objFontA1->setBold(true); 
$objStyleA1 = $objActSheet->getStyle('M2');       
$objStyleA1->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);   
$objFontA1 = $objStyleA1->getFont();       
$objFontA1->setName('宋体');          
$objFontA1->setBold(true); 
$objStyleA1 = $objActSheet->getStyle('N2');       
$objStyleA1->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);   
$objFontA1 = $objStyleA1->getFont();       
$objFontA1->setName('宋体');          
$objFontA1->setBold(true); 
$objStyleA1 = $objActSheet->getStyle('O2');       
$objStyleA1->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);   
$objFontA1 = $objStyleA1->getFont();       
$objFontA1->setName('宋体');          
$objFontA1->setBold(true); 
...
$objActSheet->setCellValue('B2', '交易单号');   
$objActSheet->setCellValue('C2', '料号');    
$objActSheet->setCellValue('D2', '料号名称'); 
$objActSheet->setCellValue('E2', '规格型号');    
$objActSheet->setCellValue('F2', '交易日期');    
$objActSheet->setCellValue('G2', '交易数量');
$objActSheet->setCellValue('H2', '单位');    
$objActSheet->setCellValue('I2', '仓库');  
$objActSheet->setCellValue('J2', '仓库');    
$objActSheet->setCellValue('K2', '申请人工号'); 
$objActSheet->setCellValue('L2', '申请人名称'); 
$objActSheet->setCellValue('M2', '交易类型'); 
$objActSheet->setCellValue('N2', '备注'); 
$objActSheet->setCellValue('O2', '单据建立时间');    
...
//$objActSheet->setCellValue('G4', '数量小计');   
 //设置边框   
    ...
    $objActSheet->getStyle('O2')->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN );   
    $objActSheet->getStyle('O2')->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN );   
    $objActSheet->getStyle('O2')->getBorders()->getRight()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN );   
    $objActSheet->getStyle('O2')->getBorders()->getBottom()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN ); 
...
//   
    ...
    $objActSheet->setCellValue('A'.$n, $i);
	  $objActSheet->setCellValue('B'.$n,$mysql['trans_num']); 
    ...
    $objActSheet->setCellValue('D'.$n, $mysql['item_name']);
	  ...
	  $objActSheet->setCellValue('F'.$n, date('Y-m-d',$mysql['transaction_date']));  
	  $objActSheet->setCellValue('G'.$n, $mysql['quantity']);    
    $objActSheet->setCellValue('H'.$n, $mysql['uom']);    
    $objActSheet->setCellValue('I'.$n, $mysql['loccode']); 
	  $objActSheet->setCellValue('J'.$n, $mysql['locationname']);    
    $objActSheet->setCellValue('K'.$n, $mysql['request_person']);  
    $objActSheet->setCellValue('L'.$n, $mysql['employee_name']);
    $objActSheet->setCellValue('M'.$n, $mysql['transaction_type']);
    $objActSheet->setCellValue('N'.$n, $mysql['remark']);
    $objActSheet->setCellValue('O'.$n, date('Y-m-d H:i:s',$mysql['creation_date']));  
