...
if (!isset($_POST['PageOffset'])) {
 ...
 $sql ="SELECT distinct  a.trans_num, a.transaction_type, a.creation_date, a.created_by,a.subinventory_from,a.schedule_date,a.wip_entity_name,c.primary_item,d.item_name,d.item_desc from inv_transactions_all_temp a,wip_jobs_all c,sf_item_no d where a.status = '待仓库签核' and a.transaction_type = '工单退料' and a.wip_entity_name = c.wip_entity_name and c.primary_item = d.item_no ";
  ...
  if (DB_num_rows($result) <> 0) 
  {
    ...
    while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> $_SESSION['DisplayRecordsMax'])) 
	{
      ...
      echo '
            ...
            <td><a href="' . $RootPath . '/WIPReturnSubApproved2.php?NUM=' . $myrow['trans_num'] . '">' . $myrow['trans_num']  . '</a></td>
