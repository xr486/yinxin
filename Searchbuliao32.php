...
$count = db_sql('select a.* from sf_item_no a where 1=1 '.$where.'',3);

$pages = ceil($count/$num);
$sql = 'select a.* from sf_item_no a  where 1=1 '.$where.' ORDER BY item_id  desc limit '.$off.','.$num.'';
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./Searchbuliao32.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
