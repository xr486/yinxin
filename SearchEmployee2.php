...
echo '<td><b>' . _('OR') . '</b></td><td>' . _('员工工号') . ':</td>
	<td>';
...
if (isset($_POST['Search']) and isset($result) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    ...
    $ListPageMax = ceil($ListCount / 150);
    ...
    echo '<tr>
                    <th class="ascending" width = 150>' . _('员工工号') . '</th>
                    <th class="ascending"width = 250>' . _('员工名称') . '</th>
         
                    <th class="ascending"width = 150>' . _('入职日期') . '</th>
                
                    <th class="ascending"width = 150>' . _('离职日期') . '</th>
                    <th class="ascending"width = 200>' . _('电话') . '</th>
                    <th class="ascending"width = 200>' . _('创建者') . '</th>
            </tr>';
    ...
    if (DB_num_rows($result) <> 0) {
        DB_data_seek($result, ($_POST['PageOffset'] - 1) * 150);
        $i = 0; //counter for input controls
        while (($myrow = DB_fetch_array($result)) AND ($RowIndex <> 150)) {
			if ($k == 1) {
