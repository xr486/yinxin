    ...
    if ($errorflag == 0) {
        ...
        foreach ($_POST as $key => $value) {
           ...
           $sql4 = "select sum(quantity) onhand_quantity from inv_onhand_quantity_all where stockid='" . $_POST['item_no' . $i]  . "' and subinventory_code ='" . $_POST['outsubinventory'.$i]  . "' and lot_num='" .$_POST['lot_num'.$i]. "' and shengchan_date='" .strtotime($_POST['shengchan_date'.$i]). "'";
            ...
            // $sqlsubcode = "select id,stockid,quantity from inv_onhand_quantity_all where stockid='" .$_POST['item_no'.$i]. "' and subinventory_code ='" . $_POST['insubinventory']  . "'  and shengchan_date='" .$shengchan_date_temp. "' and lot_num='" .$_POST['lot_num'.$i]. "'  order by id";
            ...
            //     }
            // }
            $sqlprice = "select distinct cost_price
            from inv_onhand_quantity_all where lot_num='" .$_POST['lot_num'.$i]. "'  and stockid='" . $_POST['item_no'. $i] . "' and subinventory_code ='" . $_POST['outsubinventory'. $i]  . "' ";
			...
			// and subinventory_code ='" . $_POST['outsubinventory'. $i]  . "' and shengchan_date='" .$shengchan_date_temp. "' and lot_num='" .$_POST['lot_num'.$i]. "'";
...
">工单材料超耗领用处理</p>
        ...
        //                 ";
                        ...
                        from sf_item_no a,inv_onhand_quantity_all ioq,wip_material_requierments_temp b
