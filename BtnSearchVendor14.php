...
$count = db_sql('SELECT d.*  FROM vendors d  WHERE   1=1 '.$where.'',3);

$pages = ceil($count/$num);
$sql = 'SELECT d.* FROM vendors d WHERE  1=1 '.$where.' ORDER BY vendor_code  desc limit '.$off.','.$num.'';
 // echo $sql;
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./BtnSearchVendor14.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
