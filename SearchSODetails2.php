...
<div id="CanvasDiv">
    <div id="BodyDiv">
        <div id="BodyWrapDiv">
            <p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="订单查询" alt="新建订
单">订单查询</p>
...
value="<?=$time?>">
        ...
        <tr  >
            <td>订单号:</td>  
            <td >
                  <a href="SearchSO2.php?Updateorder_number=<?=$row['order_number']?>" target="view_window"><?=$row['order_number']?>
         ...
         <tr >
                  <td>客户代码：</td>  
            <td  >
              <a href="AddCustomers.php?UpdateCustomerCode=<?=$row['customer_code']?>" target="view_window"><?=$row['customer_code']?>
            </td>
            <?php
        ...
        <tr >
           ...
           <br>
            <div>
                  ...
                  $sql = "select * from so_line_details_all where order_number='".$_GET['Updateorder_number']."' and line='".$_GET['line']."'";
                  $bomResult = DB_query($sql,$db);
                  $Bom_line_count = DB_num_rows($bomResult);
                  ?>
                  <table id="<?=$count?>" style=""  alt="<?=$Bom_line_count?>">
                         <tr >
