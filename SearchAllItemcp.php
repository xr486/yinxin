...
if($cat) {     
	$where .= "and item_category1  in ('成品料号','制成品')  "; 
}
...
$sql = 'select  a.item_no,a.item_desc,a.item_name,a.units,a.pic_path
 from sf_item_no a 
 where  1=1 '.$where.' ORDER BY item_no  desc limit '.$off.','.$num.'';
