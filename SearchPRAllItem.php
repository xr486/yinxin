...
$sql = 'select  a.item_no,a.item_desc,a.item_name,a.units,a.pic_path,a.youxiaoqi,a.project_name
 from sf_item_no a 
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./SearchPRAllItem.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
					...
					<tr class="EvenTableRows">
					 <td> <input type="checkbox" style="height: 24px;width: 24px;" name="boxlist"> </td>
						...
						:<?=$row2['youxiaoqi']?>:<?=$row2['project_name']?>">				 
						</td>
					</tr>
					<?php }?>
