...
if(isset($_POST['Search']) OR isset($_POST['Go']) OR isset($_POST['Next']) OR isset($_POST['Previous'])){
    $sql = 'select ap_invoice_type,ah.invoice_num,ah.invoice_amount,ah.tax_amount,ah.invoice_date,ah.narrative
            ,ah.vendor_code,ve.vendor_name,ah.created_by,ah.creation_date,ah.currency_code
	...
	if(isset($_POST['invoice_num']) and $_POST['invoice_num'] != ''){
        $sql = $sql." and invoice_num = '".$_POST['invoice_num']."' ";
    }
...
echo '<p class="page_title_text"><img src="' . $RootPath . '/css/' . $Theme . '/images/magnifier.png" title="' . _('Search') . '" alt="" />' . ' ' . _('应付发票明细') . '</p>';
