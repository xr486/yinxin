...
$rows = array( 
  array('工单号', '产品料号','产品名称','开工日期' ,'料号' ,'料号名称', '规格型号','数量','阶层', '需求量', '已发量','超耗量','备注' ),
...
foreach($rows as $row)
	...
	while ($v = DB_fetch_array($result_num)) {
     ...
     $v['segment1'],
     $v['item_name'],$v['item_desc'],$v['quantity_per_assembly'].' ',$v['operation_seq_num'],$v['required_quantity'], $v['quantity_issued'],$v['chaohao_quantity'],$v['comments']  ));
	 }
