...
if (isset($_POST['add_new'])) {
    header('Location: AddItemNo.php?New=Y');
}
...
if($item_name) {
 ...
 if($item_desc) {
   $where .= ' and item_desc like "%'.$item_desc.'%"';
}
...
<div id="CanvasDiv">
	...
	<div id="BodyDiv">
		<div id="BodyWrapDiv">
			...
			<form action="./SearchBOMItem.php?fwValue=<?=$cat?>&cat=<?=$cat?>" method ="POST">
				<div>
