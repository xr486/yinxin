...
if (isset($_POST['Reject'])) 
{
  ...
  $sql = "update  so_delivery_headers_all
    ...
    echo "<script>location.href='ShipOrderApprove.php';</script>";
...
<div id="BodyDiv">
<div id="BodyWrapDiv">
<p class="page_title_text"><img src="<?php echo $RootPath; ?>/css/<?php echo $Theme; ?>//images/transactions.png" title="出货单核准" alt="出货单核准">出货单核准</p>
...
<tr id="purchase_table_<?=$i?>" >
  ...
  <td><input readonly="readonly" type="text" name="so_line_no<?=$i?>"   value="<?= $myrow['so_line_no'] ?>" size="3" maxlength="150"/></td> 
   ...
   <td><input type="text" readonly="readonly" name="ship_quantity<?=$i?>" onblur="check(<?=$i?>)" id="ship_quantity<?=$i?>" value="<?=$myrow['delivery_quantity']?>" size="5" maxlength="50"  /> 
